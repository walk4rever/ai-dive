...
import { MAX_IMAGES_PER_MESSAGE, validateImageAttachments } from './image-attachment'
...
describe('validateImageAttachments', () => {
  ...
  it('strips unexpected extra fields', () => {
    const result = validateImageAttachments([{ mimeType: 'image/webp', data: 'xyz', extra: 'ignored' }])
